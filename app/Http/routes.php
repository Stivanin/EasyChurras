...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('agenda/novo', 'AgendaController@novo');
    Route::post('agenda/salvar', 'AgendaController@salvar');
    Route::get('agenda/{agenda}/editar', 'AgendaController@editar');
    Route::get('agenda/{agenda}/visualizar', 'AgendaController@visualizar');
    Route::patch('agenda/{agenda}', 'AgendaController@atualizar');
    Route::delete('agenda/{agenda}', 'AgendaController@deletar');
